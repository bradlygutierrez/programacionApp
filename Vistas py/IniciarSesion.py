...
class Ui_iniciarSesion(QtWidgets.QMainWindow, Ui_crearUsuario):
    def __init__(self):
        QtWidgets.QMainWindow.__init__(self)
        Ui_crearUsuario.__init__(self)
        self.frame = None
        self.centralwidget = None
        self.setupUi(self)


    def openCrearUsuario(self):
        self.ventana = QtWidgets.QMainWindow()
        self.ui = Ui_crearUsuario()
        self.ui.setupUi(self.ventana)
        self.ventana.show()
    def openRecuperarContrasena(self):
        self.close()
        self.ventana2 = QtWidgets.QMainWindow()
        self.ui = Ui_recuperarContrasena()
    ...
    def retranslateUi(self, iniciarSesion):
        ...
        self.commandLinkButton_2.clicked.connect(self.openCrearUsuario)
        self.commandLinkButton.clicked.connect(self.openRecuperarContrasena)
        self.commandLinkButton_3.clicked.connect(self.cerrar_ventana)
